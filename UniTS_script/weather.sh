...
# 96 best sl 576 bs gre 0 lre 0 best lr 1e-3 ims 16 dek 25
# 192 sl 576 bs 256 lr 1e-2 ims 16 dek 51 ul 1
# 336 sl 576 bs 256 lr 5e-3 ims 16 dek 51 gre 1
# 720 sl 640 bs 256 lr 1e-3 ims 16 dek 25 gre 1
for bbs in 256; do
    #  relu gelu tanh
    for predl in 720; do
        for dr in 0.99; do
            for nhl in 1; do
                for norm in revin; do
                    for pl in 16 64 32; do
                        for stride in 8 16; do
                            for ims in 128 16 32 64; do
                                for nah in 1; do
                                    for d in 1; do
                                        for pembed in 1; do
