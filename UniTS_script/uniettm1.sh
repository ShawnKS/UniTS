...
# 96 best sl 288 bs 256 gre 1 lre 0  best lr 0.0008 ims 16
# 192 best sl 288 bs 256 ims 32 gre 1 lr 0.0008 ims 32
# 336 best sl 720 bs 256 ims 32 lr 0.0008 gre gap很小
# 720 best sl 576 bs 256 ims 32 lr 0.0005 gre 1

# 96 best sl 288 bs 256 ul 1 gre 1 lre 0  best lr 0.0008 ims 16 dek 25
# 192 best sl 288 bs 256 ims 32 gre 1 lr 0.0008 ims 32
# 336 best sl 720 bs 256 ims 32 lr 0.0008 gre gap很小
# 720 best sl 576 bs 256 ims 32 lr 0.0005 gre 1
for bbs in 256; do
        ...
        for dr in 0.99; do
            for nhl in 1; do
                for norm in revin; do
                    for pl in 1; do
                        for stride in 1; do
                            for ims in 16 32 48; do
                                for nah in 1; do
                                    for d in 1; do
                                        for pembed in 0 1; do
                                            for lr in 0.0005 0.0008; do
                                                for convkernel in 25; do
                                                    for decom in 13 25 51; do
                                            #  linear dynamic
                                                        for sl in 384 720; do
                                                            # 寻找空闲的 GPU
                                                            gpu_found=false
                                                            max_wait=10000  # 最大等待
