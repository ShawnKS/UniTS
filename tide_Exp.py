...
from models.TiDE import Model as TiDEModel
...
parser.add_argument('--dr', type=float, default=0.978,
                    help='decay rate')
parser.add_argument('--astep', type=int, default=1,
...
parser.add_argument('--pp', type=str, default='end',
                    help='padding_patch')
# add 9.10
parser.add_argument('--usepe', type=int, default=1)
...
path = './PPatchTST_output/' + str(args.dataset) + '/' + str(args.prel) + '/'
...
class Args:
    def __init__(self):
        ...
        self.is_training = 1
        self.root_path = '/home/covpreduser/Blob/v-xiaosong/task-meta-feature/series/Time-Series-Library/dataset/ETT-small/'
...
custom_model = TiDEModel(configs=data_args).to(device)
